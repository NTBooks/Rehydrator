...
import { FILES_DIR_PATH } from './constants.js';

export async function buildAndPrintCIDSummary(events) {
    try {
        ...
        for (const item of summary) {
            ...
            const timestampStr = item.timestamp.toISOString().replace('T', ' ').substring(0, 19);
